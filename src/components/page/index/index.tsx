    ...
    <div {...props} className={clsx(props.className, styles.appWizard)}>
      <div className="row">
        ...
        <div className="item" style={{ marginLeft: 30 }}>
          <Fast />{' '}
          <span className="item-name" style={{ marginLeft: 20 }}>
      ...
      <div className="row">
        <div className="item">
          <Terminal />{' '}
          <span className="item-name" style={{ marginLeft: 21 }}>
            Built for developers
          </span>
        </div>
        <div className="item" style={{ marginLeft: 30 }}>
          <Gear />{' '}
          <span className="item-name" style={{ marginLeft: 28 }}>
...
export const Blaze = (props) => (
  <svg width={19} height={27} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
...
export const Fast = (props) => (
  <svg width={27} height={19} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
